...
func TestNewNumber(t *testing.T) {
    tests := []struct {
    ...
    }{
        {
            name:        "long",
            constructor: NewLong,
            want:        &Number{_type: TypeNumberLong},
        },
        {
            name:        "integer",
            constructor: NewInteger,
            want:        &Number{_type: TypeNumberInteger},
        },
        {
            name:        "short",
            constructor: NewShort,
            want:        &Number{_type: TypeNumberShort},
        },
        {
            name:        "byte",
            constructor: NewByte,
            want:        &Number{_type: TypeNumberByte},
        },
        {
            name:        "double",
            constructor: NewDouble,
            want:        &Number{_type: TypeNumberDouble},
        },
        {
            name:        "float",
            constructor: NewFloat,
            want:        &Number{_type: TypeNumberFloat},
        },
        {
            name:        "half_float",
            constructor: NewHalfFloat,
            want:        &Number{_type: TypeNumberHalfFloat},
        },
        {
            name:        "scaled_float",
            constructor: NewScaledFloat,
            want:        &Number{_type: TypeNumberScaledFloat},
        },
    }
