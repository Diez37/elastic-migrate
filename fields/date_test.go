...
func TestNewDate(t *testing.T) {
	...
	tests := []struct {
		...
		{
			args: args{name: "test"},
			want: &Date{_type: TypeDate, name: "test"},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := NewDate(tt.args.name); !reflect.DeepEqual(got, tt.want) {
...
func TestNewDateNano(t *testing.T) {
	...
	tests := []struct {
		...
		{
			args: args{name: "test"},
			want: &Date{_type: TypeDateNano, name: "test"},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := NewDateNano(tt.args.name); !reflect.DeepEqual(got, tt.want) {
