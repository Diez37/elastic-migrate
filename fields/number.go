...
func NewLong(name string) *Number {
	return &Number{name: FieldName(name), _type: TypeNumberLong}
}

func NewInteger(name string) *Number {
	return &Number{name: FieldName(name), _type: TypeNumberInteger}
}

func NewShort(name string) *Number {
	return &Number{name: FieldName(name), _type: TypeNumberShort}
}

func NewByte(name string) *Number {
	return &Number{name: FieldName(name), _type: TypeNumberByte}
}

func NewDouble(name string) *Number {
	return &Number{name: FieldName(name), _type: TypeNumberDouble}
}

func NewFloat(name string) *Number {
	return &Number{name: FieldName(name), _type: TypeNumberFloat}
}

func NewHalfFloat(name string) *Number {
	return &Number{name: FieldName(name), _type: TypeNumberHalfFloat}
}

func NewScaledFloat(name string) *Number {
	return &Number{name: FieldName(name), _type: TypeNumberScaledFloat}
}

func (field *Number) Name() FieldName {
	return field.name
}
